...
(defalias
  ...
  s (tap-hold-release-keys $tap-time $hold-time s lmet (q w e r t a s d f g z x c v b))
  d (tap-hold-release-keys $tap-time $hold-time d lsft (q w e r t a s d f g z x c v b))
  f (tap-hold-release-keys $tap-time $hold-time f lctl (q w e r t a s d f g z x c v b))
  j (tap-hold-release-keys $tap-time $hold-time j rctl (y u i o p h j k l ; n m , . /))
  k (tap-hold-release-keys $tap-time $hold-time k rsft (y u i o p h j k l ; n m , . /))
  l (tap-hold-release-keys $tap-time $hold-time l rmet (y u i o p h j k l ; n m , . /))
